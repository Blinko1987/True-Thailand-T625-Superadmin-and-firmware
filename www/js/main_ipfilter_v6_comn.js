...
function extraValidCheck()
{
    ...
    else if ($("#ipfilter_MinSourceAddress").val() != "" && isValidIpv6Address($("#ipfilter_MinSourceAddress").val()) == false)
    {
        $("#MinSourceAddress-error").html("srcipinvalid".i18n());
         return false;
    }
    else if ($("#ipfilter_MaxSourceAddress").val() != "" && isValidIpv6Address($("#ipfilter_MaxSourceAddress").val()) == false)
    {
        $("#MaxSourceAddress-error").html("srcipinvalid".i18n());
        return false;
    }
    else if ($("#ipfilter_MinDestinationAddress").val() != "" && isValidIpv6Address($("#ipfilter_MinDestinationAddress").val()) == false)
    {
        $("#MinDestinationAddress-error").html("destipinvalid".i18n());
        return false;
    }
    else if ($("#ipfilter_MaxDestinationAddress").val() != "" && isValidIpv6Address($("#ipfilter_MaxDestinationAddress").val()) == false)
    {
	...
	else if ($("#ipfilter_MinSourceAddress").val() != "" && $("#ipfilter_MaxSourceAddress").val() != "" && (isValidIPv6AddressRange($("#ipfilter_MinSourceAddress").val(), $("#ipfilter_MaxSourceAddress").val()) == false ))
	{
		$("#MaxSourceAddress-error").html("maxsrcaddrcannotlessthanminsrcaddr".i18n());
		return false;
	}
	else if ($("#ipfilter_MinDestinationAddress").val() != "" && $("#ipfilter_MaxDestinationAddress").val() != "" && (isValidIPv6AddressRange($("#ipfilter_MinDestinationAddress").val(), $("#ipfilter_MaxDestinationAddress").val()) == false ))
	{
