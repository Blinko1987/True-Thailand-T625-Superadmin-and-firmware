...
function initPage()
{
	if(gDebug)
	{
		getDataByAjax("../fake/wlanBasicSettings", fillData);
	}else{
		XHR.get("wlanBasicSettings", null, fillData);
	}
}
...
function saveApply()
{
	...
	else
	{
		...
		if(gDebug)
		{
			...
			data.token = tokenstr;
			XHR.post("setWlanBasicCfg", data, reloadSaveData);
		}
	}
}
...
function reloadData(responseData)
{
	...
	{
		alert("submitwifibasicparasfail".i18n());
	}
}
...
function checkWlanCommonFields()
{
	...
	if (ssid == gallData5g.ssid1 || ssid == gallData5g.ssid2 || ssid == gallData5g.ssid3 || ssid == gallData5g.ssid4)
	{
		samessid1 = 1;
	}
	...
	if (samessid1 == 1)
	{
		if ( (gallData.ssid2 != "" && (gallData.ssid2 == gallData5g.ssid1 || gallData.ssid2 == gallData5g.ssid2 || gallData.ssid2 == gallData5g.ssid3 || gallData.ssid2 == gallData5g.ssid4))
			|| (gallData.ssid3 != "" && (gallData.ssid3 == gallData5g.ssid1 || gallData.ssid3 == gallData5g.ssid2 || gallData.ssid3 == gallData5g.ssid3 || gallData.ssid3 == gallData5g.ssid4))
			|| (gallData.ssid4 != "" && (gallData.ssid4 == gallData5g.ssid1 || gallData.ssid4 == gallData5g.ssid2 || gallData.ssid4 == gallData5g.ssid3 || gallData.ssid4 == gallData5g.ssid4))
		)
		{
			samessid2 = 1;
		}
...
{
	window.location.href = "wlan_multissid_info_comn.html";
}
