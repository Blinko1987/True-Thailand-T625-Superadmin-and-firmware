...
$(document).ready(function(){
	...
	XHR.get("get_login_user", null, function(data){
		...
		if (login_user == 1)
		{
			document.getElementById("ap2_tr").style.display = "";
			document.getElementById("ssid7").style.display = "";
		}
		else
		{
			document.getElementById("ap2_tr").style.display = "none";
...
function getData()
{
	...
	{
		XHR.get("wlanBasicSettingsAll_5G", null, parseGetData);
	}
}
...
function saveApply()
{
	...
	{
		if (($("#WlanSsid_text1").val() != "" && ($("#WlanSsid_text1").val() == gallData["ssid1"].SSID || $("#WlanSsid_text1").val() == gallData["ssid3"].SSID || $("#WlanSsid_text1").val() == $("#WlanSsid_text3").val()))
			|| ($("#WlanSsid_text3").val() != "" && ($("#WlanSsid_text3").val() == gallData["ssid1"].SSID || $("#WlanSsid_text3").val() == $("#WlanSsid_text1").val() || $("#WlanSsid_text3").val() == gallData["ssid3"].SSID))
		)
		{
			alert("ssidnotsameforsameband".i18n());
			return false;
	...
	if ( gallData["ssid1"].SSID != "" && (gallData["ssid1"].SSID == gallData2g.ssid1 || gallData["ssid1"].SSID == gallData2g.ssid2 || gallData["ssid1"].SSID == gallData2g.ssid3 || gallData["ssid1"].SSID == gallData2g.ssid4))
	{
		samessidnum = samessidnum + 1;
	}
	
	if ( $("#WlanSsid_text1").val() != "" && ($("#WlanSsid_text1").val() == gallData2g.ssid1 || $("#WlanSsid_text1").val() == gallData2g.ssid2 || $("#WlanSsid_text1").val() == gallData2g.ssid3 || $("#WlanSsid_text1").val() == gallData2g.ssid4))
	{
		samessidnum = samessidnum + 1;
	}
	...
	if (login_user == 1)
	{
		if ( samessidnum < 2 && $("#WlanSsid_text2").val() != "" && ($("#WlanSsid_text2").val() == gallData2g.ssid1 || $("#WlanSsid_text2").val() == gallData2g.ssid2 || $("#WlanSsid_text2").val() == gallData2g.ssid3 || $("#WlanSsid_text2").val() == gallData2g.ssid4))
		{
			samessidnum = samessidnum + 1;
		}
	}
	...
	{
		if ( samessidnum < 2 && gallData["ssid3"].SSID != "" && (gallData["ssid3"].SSID == gallData2g.ssid1 || gallData["ssid3"].SSID == gallData2g.ssid2 || gallData["ssid3"].SSID == gallData2g.ssid3 || gallData["ssid3"].SSID == gallData2g.ssid4))
		{
			samessidnum = samessidnum + 1;
		}
	}
	
	if ( samessidnum < 2 && $("#WlanSsid_text3").val() != "" && ($("#WlanSsid_text3").val() == gallData2g.ssid1 || $("#WlanSsid_text3").val() == gallData2g.ssid2 || $("#WlanSsid_text3").val() == gallData2g.ssid3 || $("#WlanSsid_text3").val() == gallData2g.ssid4))
	{
		samessidnum = samessidnum + 1;
	}

	// if ( samessidnum < 2 && $("#WlanSsid_text4").val() != "" && ($("#WlanSsid_text4").val() == gallData2g.ssid1 || $("#WlanSsid_text4").val() == gallData2g.ssid2 || $("#WlanSsid_text4").val() == gallData2g.ssid3 || $("#WlanSsid_text4").val() == gallData2g.ssid4 || $("#WlanSsid_text4").val() == gallData2g.ssid5
	// 	|| $("#WlanSsid_text4").val() == gallData2g.ssid6 || $("#WlanSsid_text4").val() == gallData2g.ssid7 || $("#WlanSsid_text4").val() == gallData2g.ssid8))
	// {
	// 	samessidnum = samessidnum + 1;
	// }

	// if ( samessidnum < 2 && $("#WlanSsid_text5").val() != "" && ($("#WlanSsid_text5").val() == gallData2g.ssid1 || $("#WlanSsid_text5").val() == gallData2g.ssid2 || $("#WlanSsid_text5").val() == gallData2g.ssid3 || $("#WlanSsid_text5").val() == gallData2g.ssid4 || $("#WlanSsid_text5").val() == gallData2g.ssid5
	// 	|| $("#WlanSsid_text5").val() == gallData2g.ssid6 || $("#WlanSsid_text5").val() == gallData2g.ssid7 || $("#WlanSsid_text5").val() == gallData2g.ssid8))
	// {
	// 	samessidnum = samessidnum + 1;
	// }

	// if ( samessidnum < 2 && $("#WlanSsid_text6").val() != "" && ($("#WlanSsid_text6").val() == gallData2g.ssid1 || $("#WlanSsid_text6").val() == gallData2g.ssid2 || $("#WlanSsid_text6").val() == gallData2g.ssid3 || $("#WlanSsid_text6").val() == gallData2g.ssid4 || $("#WlanSsid_text6").val() == gallData2g.ssid5
	// 	|| $("#WlanSsid_text6").val() == gallData2g.ssid6 || $("#WlanSsid_text6").val() == gallData2g.ssid7 || $("#WlanSsid_text6").val() == gallData2g.ssid8))
	// {
	// 	samessidnum = samessidnum + 1;
	// }

	// if ( samessidnum < 2 && $("#WlanSsid_text7").val() != "" && ($("#WlanSsid_text7").val() == gallData2g.ssid1 || $("#WlanSsid_text7").val() == gallData2g.ssid2 || $("#WlanSsid_text7").val() == gallData2g.ssid3 || $("#WlanSsid_text7").val() == gallData2g.ssid4 || $("#WlanSsid_text7").val() == gallData2g.ssid5
	// 	|| $("#WlanSsid_text7").val() == gallData2g.ssid6 || $("#WlanSsid_text7").val() == gallData2g.ssid7 || $("#WlanSsid_text7").val() == gallData2g.ssid8))
	// {
	// 	samessidnum = samessidnum + 1;
	// }
	...
	if(gDebug)
	{
		...
		data.token = tokenstr;
		XHR.post("setMutiSSID_5G", data, reloadSaveData);
	}
}
